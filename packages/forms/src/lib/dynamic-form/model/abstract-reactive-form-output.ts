...
export abstract class AbstractReactiveFormOutput<DT> implements IReactiveFormElement<DT> {
  ...
  constructor( options: DynamicReactiveFormElementOptions<DT> ) {
    ...
    this.accumulateArguments = options.accumulateArguments !== null ? options.accumulateArguments : false;
  }
}
