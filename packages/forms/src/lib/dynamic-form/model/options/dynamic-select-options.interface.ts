...
export interface DynamicSelectOptions<T = SelectOptionValueType> extends DynamicReactiveFormQuestionOptions<SelectOption<T> | SelectOptionGroup<T>, SelectOptionValueType> {
