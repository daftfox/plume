  ...
  public override examples: Example[] = [
    {
      ...
      description: 'The boolean checkbox we\'ve all come to love. Simply provide a key and label and off you go.',
      key: 'basicCheckbox',
      panelOpen: false,
...
export class FormComponent {
  formElements = [
    ...
    },
    {
      ...
      description: 'The same checkbox, but disabled through the <code>disabled</code> configuration property.',
...
export class FormComponent {
  formElements = [
    new DynamicCheckbox({
      ...
      description: 'A couple of checkboxes grouped together in a <code>DynamicFormGroup</code>. Refer to <a href="form-group">form group</a> for more information regarding grouping options.',
